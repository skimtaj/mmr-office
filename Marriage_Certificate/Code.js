...
app.get('/Pdf/:id', async (req, res) => {
    try {
        ...
        async function CreatePdf(input, pdf_data) {
            ...
            form.getTextField('BGName').setText(pdf_data.Name || '');
            form.getTextField('BGFather').setText(pdf_data.Father_Name || '');
            form.getTextField('BGAge').setText(pdf_data.DOB || '');
        ...
        const pdfBytes = await CreatePdf('./Marriage_Certificate/Pdf/Last.pdf', pdf_data);
