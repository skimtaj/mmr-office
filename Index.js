...
app.get('/Dashboard/:AdminID', async function (req, res) {
  ...
  res.render('../Views/Dashboard', { Admin_Data, countUser, totalUser })
})
...
app.get('/Dashboard/:AdminID/New_Registration', async function (req, res) {
  ...
  res.render('../Views/New_Registration', { Admin_source })
})
...
app.get('/Edit_User/:id', async function (req, res) {
  try {
    ...
    res.render('../Views/Edit_Registration', { User_Edit_Data, Admin_Source });
